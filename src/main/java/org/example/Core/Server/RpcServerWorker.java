    ...
    public void run() {
        try {
            ...
            if(rpcRequest.getHeader().equals("version=1")) {
                ...
                RpcResponseBody rpcResponseBody = RpcResponseBody.builder().retObject(returnObject).build();
                ...
                RpcResponse rpcResponse = RpcResponse.builder().header("version=1").body(bytes).build();
